			...
			<div className="notice-satisfaction">
				<div className="notice-satisfaction-area">
					...
					<ul className="content">
						[ 이정환 강사님 현직자 특강 만족도 조사 안내]
						<ol>여러분들~! 강의 모두 잘 들으셨기를 바라며,</ol>
						<ol>만족스러우셨다면 의견 부탁드리겠습니다~</ol>
						<ol>여러분들의 만족도를 아래 설문폼을 통해 작성해 주세요!</ol>
						<a
					...
					<ul className="content">
						...
						<ol>
							<a
								...
								[패스트캠퍼스] 프론트엔드 개발 부트캠프 8기 특강 만족도 설문
								조사
							</a>
						</ol>
						<ol>안녕하세요. 패스트캠퍼스입니다.</ol>
						<ol>특강은 만족스러우셨나요??</ol>
						<ol>특강에 대한 여러분들의 의견과 만족도를 작성해 주세요!</ol>
						<ol>
